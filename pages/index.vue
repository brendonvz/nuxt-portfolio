...
<template>
  <section>
    <h1 class="text-5xl font-bold mt-20">👋🏻 Hello, I'm Brendon van Zanten!</h1>
    <p class="text-base text-gray-900 p-2 italic">Senior Web Developer at DSBN</p>
  </section>
	<section class="flex flex-col md:flex-row">
    <div class="md:w-3/4">
      <h2 class="text-3xl font-bold mt-8">My Story</h2>
      <p class="text-lg py-2">
        I am a Web Developer living just outside of one of my favorite places in the world, Vineland, Ontario. I am a
    ...
    <img src="~/assets/images/profilepic.png" class="w-1/2 md:max-w-sm p-8 mx-auto" />
  </section>
  <section>
